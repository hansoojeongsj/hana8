...
public class DeptController {
	...
	@GetMapping("/{id}")
	// @Tag(name = "부서 상세", description = "부서 세부 정보") // class에 걸면 method에도 있어서 스웨거에 중복됨
	...
	@io.swagger.v3.oas.annotations.parameters.RequestBody(
		description = "부서 정보(부서명은 중복되지 않게 변경하세요)",
		content = @Content(
	...
	DeptDTO registDept(@Parameter(description = "부서 정보", example = """
		{
		  "name": "Devxxx",
		  "captain": {
		    "id": 1
		...
		""")
	@Valid() @RequestBody DeptDTO dept) {
